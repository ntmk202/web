                ...
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						echo '<li class="collection-item avatar">
                              <i class="mdi-content-content-paste amber lighten-2 circle"></i>
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
                            ...
                            <span>Rs. '.$row1['price'].'</span>
								...
								if(!$deleted){
								echo '<button class="btn amber darken-4 waves-effect waves-light right submit" type="submit" name="action">Change Status
