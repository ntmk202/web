    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Manage orders</a>
            </li>
                <li class="no-padding">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Orders list</h4>
              </div>
              <div>
			  ...
			  <div class="input-field col s12">
                              <button class="btn amber lighten-2 waves-effect waves-light right" type="submit" name="action">Modify
...
<table>
			  ...
			  <div class="input-field col s12">
                              <button class="btn amber lighten-2 waves-effect waves-light right" type="submit" name="action">Add
                                <i class="mdi-content-send right"></i>
                              </button>
                            </div>
            </div>
