...
<head>
  ...
  <title>Contact No. <?php echo $ticket_id.' - '. $type;?></title>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> All orders</a>
            </li>
                <li class="no-padding">
                ...
                <li class="bold"><a href="admin-voucher.php" class="waves-effect waves-cyan"><i class="mdi-maps-local-attraction"></i> Voucher</a>
            </li>
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
...
<div class="section">
								...
								echo '<ul id="task-card" class="collection with-header">
									<div id="card-alert" class="card amber lighten-2">
								...
								while($row1 = mysqli_fetch_array($sql1)){
								  ...
								  <li class="collection-item avatar">
									  <i class="'.($role1=='Administrator' ? 'mdi-action-star-rate' : 'mdi-social-person').' amber lighten-2 circle"></i>
                  ...
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/ticket-message.php" novalidate="novalidate" class="col s12">					  
					  ...
					  <input type="hidden" name="ticket_id" value="'.$ticket_id.'">
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            <button class="btn amber lighten-2 waves-effect waves-light right" type="submit" name="action">Reply
