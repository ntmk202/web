            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-content-add-circle"></i> Create orders</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> History</a>
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
							...
							$id = $row1['order_id'];
								...
								echo '<form action="routers/cancel-order.php" method="post">
										...
										<button class="btn amber darken-4 waves-effect waves-light right submit" type="submit" name="action">Cancel Order
