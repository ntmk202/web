...
<head>
  ...
  <!-- Favicons-->
  <link rel="apple-touch-icon-precomposed" href="img/logo-head.png">
  <!-- For iPhone -->
  <meta name="msapplication-TileColor" content="#00bcd4">
  <meta name="msapplication-TileImage" content="img/logo-head.png">
  <!-- For Windows Phone -->
  ...
  <div id="main">
    ...
    <div class="wrapper">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-content-add-circle"></i> Create orders</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> History</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-communication-forum"></i> Contact</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="<?php
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">If you're experiencing any issues, contact us by opening a message.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Create a message</h4>
              </div>
<div>
                    ...
                    <form class="formValidate" id="formValidate" method="post" action="routers/add-ticket.php" novalidate="novalidate" class="col s12">
                      <div class="row">
                        <div class="input-field col s12">
                          <input name="subject" id="subject" type="email" data-error=".errorTxt1">
                      ...
                      <div class="row">
                        <div class="row">
						  ...
						  <input type="hidden" value="<?php echo $user_id;?>" name="id">
                            <button class="btn amber lighten-2 waves-effect waves-light right" type="submit" name="action">Submit
								...
								<?php
									...
									echo'<a href="view-ticket.php?id='.$row['id'].'"class="collection-item">
                                        <div class="row">
                                            ...
                                            <span class="task-cat amber darken-2">'.$row['status'].'</span></div>											
                                            <div class="col s12 m2">
